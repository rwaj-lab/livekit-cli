...
func NewVP9VideoLooper(input io.Reader, spec *videoSpec) (*VP9VideoLooper, error) {
	l := &VP9VideoLooper{
		spec:          spec,
...
func (l *VP9VideoLooper) Codec() webrtc.RTPCodecCapability {
...
func (l *VP9VideoLooper) NextSample(_ctx context.Context) (media.Sample, error) {
	return l.nextSample(true)
}

func (l *VP9VideoLooper) ToLayer(quality livekit.VideoQuality) *livekit.VideoLayer {
	return l.spec.ToVideoLayer(quality)
}

func (l *VP9VideoLooper) nextSample(rewindEOF bool) (media.Sample, error) {
	sample := media.Sample{}
	if l.reader == nil {
		var err error
